CREATE SEQUENCE SEQ_SYS_DPT START 1000000;
CREATE SEQUENCE SEQ_SYS_DPT_LOG START 1000000;

CREATE SEQUENCE SEQ_SYS_USER START 1000000;
CREATE SEQUENCE SEQ_SYS_USER_LOG START 1000000;

CREATE SEQUENCE SEQ_SYS_MENU START 1000000;
CREATE SEQUENCE SEQ_SYS_MENU_LOG START 1000000;

CREATE SEQUENCE SEQ_SYS_ROLE START 1000000;
CREATE SEQUENCE SEQ_SYS_ROLE_LOG START 1000000;

CREATE SEQUENCE SEQ_SYS_NOTICE START 1000000;
CREATE SEQUENCE SEQ_SYS_NOTICE_LOG START 1000000;

CREATE SEQUENCE SEQ_SYS_ACCESS_LOG START 1000000;
...
CREATE TABLE SYS_DICT (
  ...
  DICT_ENABLE INT NOT NULL DEFAULT 1,
...
CREATE TABLE SYS_DICT_OPT (
  ...
  DICT_OPT_ENABLE INT NOT NULL DEFAULT 1,
...
CREATE TABLE SYS_DPT (
  ...
  DPT_ENABLE INT NOT NULL DEFAULT 1,
...
CREATE TABLE SYS_USER (
  ...
  USER_GENDER BIGINT NOT NULL DEFAULT 0,
  USER_BIRTHDAY TIMESTAMPTZ,
  USER_EMAIL VARCHAR(100),
  USER_PHONE VARCHAR(100),
  USER_ADDR VARCHAR(100),
  USER_CREATE_TIME TIMESTAMPTZ,
  USER_UPDATE_TIME TIMESTAMPTZ,
  USER_ENABLE INT NOT NULL DEFAULT 1,
...
CREATE TABLE SYS_MENU (
  ...
  MENU_ENABLE INT NOT NULL DEFAULT 1,
...
CREATE TABLE SYS_ROLE (
  ...
  ROLE_ENABLE INT NOT NULL DEFAULT 1,
...
CREATE TABLE SYS_NOTICE (
  ...
  NOTICE_START_TIME TIMESTAMPTZ NOT NULL,
  NOTICE_END_TIME TIMESTAMPTZ NOT NULL,
  NOTICE_CREATE_TIME TIMESTAMPTZ,
  NOTICE_UPDATE_TIME TIMESTAMPTZ,
...
CREATE TABLE SYS_ACCESS_LOG (
  LOG_ID BIGINT NOT NULL,
  LOG_ACCESS_TIME TIMESTAMPTZ NOT NULL,
